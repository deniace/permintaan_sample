...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <div class="float-left font-weight-bold text-primary">Tambah Area</div>
        </div>
        <div class="card-body">
            ...
            <form method="post" action="{{"/areas"}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_area') is-invalid @enderror" name="nama_area"
                        id="nama_area" placeholder="Nama Area" value="{{old("nama_area")}}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('singkatan_area') is-invalid @enderror"
                        ...
                        value="{{old("singkatan_area")}}" required>
